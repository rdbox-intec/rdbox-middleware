...
class RdboxNodeList(object):
    ...
    def to_RdboxNodeList(self, k8s_external_list):
        list_of_external = k8s_external_list.get_external_list()
        tmp = []
        for external in list_of_external:
    ...
    def group_by(self, member_name):
        ...
        for rdbox_node in self.list:
            group_key = getattr(rdbox_node, member_name,
                                K8sResponseHelper.LOCATION_NOT_DEFINE)
